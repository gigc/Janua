...
void TgcDX10Shaders::loadCommonShaders()
{
	string shadersPath = GuiController::Instance->engineMediaPath + "Shaders\\DirectX10\\";
...
void TgcDX10Shaders::adaptMatrix(Matrix4 &mat)
{
	//Do nothing
}